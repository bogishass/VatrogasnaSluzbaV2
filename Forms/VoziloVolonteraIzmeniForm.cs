...
{
    public partial class VoziloVolonteraIzmeniForm : Form
    {
        public VoziloVolonteraIzmeniForm()
        {
            InitializeComponent();
        }

        private void VoziloVolonteraIzmeniForm_Load(object sender, EventArgs e)
        {
